defmodule CrosstodoWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :crosstodo
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :crosstodo
  end
